...
from age_gender.helper import nms, adjust_input, detect_first_stage_warpper
...
class MtcnnDetector(object):
    ...
    def detect_face(self, img, det_type=0):
        ...
        if det_type == 0:
            ...
            if img is None:
                print('328 img is None')
                return None

            # only works for color image
            if len(img.shape) != 3:
                print('333 len(img.shape) ', len(img.shape))
                return None
            ...
            if len(total_boxes) == 0:
                print('372 len(total_boxes) == 0')
                return None

            total_boxes = np.vstack(total_boxes)

            if total_boxes.size == 0:
                print('378 total_boxes.size == 0')
                return None
